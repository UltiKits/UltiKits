...
import com.ultikits.plugins.kits.i18n.UltiKitsLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiKitsLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiKitsLanguageCatalogueTest.loadModuleCatalogues()) {
